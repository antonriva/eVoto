...
CREATE TABLE Domicilio (
    ...
    IdDeMunicipio INT NOT NULL,
    IdDeLocalidad INT,
    IdDeCodigoPostal INT, -----AGREGADOS A POSTERIORI, DEBE CREARSE UNA TABLA PARA ESTO
...
CREATE TABLE Partido (
    ...
    fechaDeInicio DATE NOT NULL,
    fechaDeFin DATE,
    CONSTRAINT fk_partido_logo FOREIGN KEY (IdDeLogo) REFERENCES Visual(Id)
);
...
CREATE TABLE ProcesoLugar (
    ...
    IdDeEntidad INT,
    IdDeMunicipio INT, 
    PRIMARY KEY (IdDeInstanciaDeProceso, IdDeNivel),
    CONSTRAINT fk_procesolugar_nivel FOREIGN KEY (IdDeNivel) REFERENCES Nivel(Id),
    CONSTRAINT fk_procesolugar_instanciadeproceso FOREIGN KEY (IdDeInstanciaDeProceso) REFERENCES InstanciaDeProceso(Id),
...
CREATE TABLE PersonaCandidatura (
    ...
    CONSTRAINT fk_personacandidatura_persona FOREIGN KEY (IdDePersona) REFERENCES Persona(Id),
    CONSTRAINT fk_personacandidatura_candidatura FOREIGN KEY (IdDeCandidatura) REFERENCES Candidatura(Id)
);
