...
-- -----NACE UN PARTIDO 
    ...
    VALUES (1, 1,v_proceso_lugar_1, 1, TO_DATE('2024-12-17 00:00:00','YYYY-MM-DD HH24:MI:SS'), TO_DATE('2024-12-17 23:59:59','YYYY-MM-DD HH24:MI:SS'))
    RETURNING ID INTO v_id_instancia1;

    INSERT INTO INSTANCIADEPROCESO(IDDEPROCESO, IDDENIVEL, IDDEPROCESOLUGAR, GANADORESNUM, FECHAHORADEINICIO, FECHAHORADEFIN)
    VALUES (4, 2, v_proceso_lugar_2, 1, TO_DATE('2024-12-17 00:00:00','YYYY-MM-DD HH24:MI:SS'), TO_DATE('2024-12-17 23:59:59','YYYY-MM-DD HH24:MI:SS'))
...
BEGIN
    INSERT INTO PARTIDO (DENOMINACION, SIGLAS, FECHADEINICIO)
    VALUES ('PARTIDO VERDE ECOLOGISTA DE MEXICO', 'PVEM', TO_DATE('1986-02-15', 'YYYY-MM-DD'))
    RETURNING ID INTO v_id_partido;

    DBMS_OUTPUT.PUT_LINE('Partido creado con ID: ' || v_id_partido);
END;
/
